...
class UNet3Plus(nn.Module):
    def __init__(self, num_classes=1, deep_sup=True):
        ...
        """ Frequency """
        self.freq_e1 = FreqEdgeFusionBlockV2(64)
        self.freq_e2 = FreqEdgeFusionBlockV2(128)
        self.freq_e3 = FreqEdgeFusionBlockV2(256)
        self.freq_e4 = FreqEdgeFusionBlockV2(512)
        self.freq_e5 = FreqEdgeFusionBlockV2(1024)
